...
def salva_qso(
    ...
    # Gestione pulita delle note: se vuote o None, mette un trattino "-"
    ...
    if os.path.exists(csv_temp):
        ...
        # Sostituisce eventuali NaN ereditati dal file csv con il trattino
...
with col1:
    ...
    with st.form("qso_form", clear_on_submit=True):
        ...
        submitted = st.form_submit_button("💾 Salva QSO & Aggiorna PDF", use_container_width=True)
...
with col2:
    ...
    if os.path.exists("temp_log.csv"):
        ...
        # Pulisce eventuali vecchi NaN nel dataframe a schermo
